...
public class FilePickerDialog extends Dialog implements AdapterView.OnItemClickListener {
    ...
    public FilePickerDialog(Context context, DialogProperties properties, int textColor, int bgColor) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFileListAdapter = new FileListAdapter(internalList, context, properties, textColor);
    ...
    public void show() {
        ...
        try {
            Objects.requireNonNull(super.getWindow()).getDecorView().getBackground().setColorFilter(new LightingColorFilter(0xFF000000, bgColor));
